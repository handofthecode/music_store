...
this["JST"]["new_album"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form action=\"/albums\" method=\"post\">	<h1>Add Album</h1>	<fieldset>		<dl>			<dt>				<label>Title</label>			</dt>			<dd>				<input type=\"text\" name=\"title\">			</dd>			<dt>				<label>Artist</label>			</dt>			<dd>				<input type=\"text\" name=\"artist\">			<dd>				<label>Date</label>			</dd>			<dd>				<input type=\"date\" name=\"date\">			</dd>			<dt>				<label>Cover</label>			<dd>				<input type=\"url\" name=\"cover\">			</dd>			<dt>				<label>Price</label>			</dt>			<dd>				<input type=\"text\" name=\"price\">			</dd>		<fieldset class=\"actions\">			<input type=\"submit\" value=\"Create\">		</fieldset>";
},"useData":true});